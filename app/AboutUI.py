...
class Ui_AboutWindow(object):
    ...
    def retranslateUi(self, AboutWindow):
        ...
        self.app_name_lb.setText(
            QCoreApplication.translate("AboutWindow", "Image Sticher", None)
        )
